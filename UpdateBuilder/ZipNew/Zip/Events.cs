...
namespace UpdateBuilder.ZipNew.Zip
{
    ...
    ///   cref="ZipFile.AddEntry(string,UpdateBuilder.ZipNew.Zip.WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="ZipFile.AddEntry(string,UpdateBuilder.ZipNew.Zip.WriteDelegate)"/>
