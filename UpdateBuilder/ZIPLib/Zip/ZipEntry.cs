...
namespace UpdateBuilder.ZIPLib.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="ZipFile.ForceNoCompression"/>
        ...
        ///
        /// </remarks>
        /// <seealso cref="ZipFile.WillReadTwiceOnInflation"/>
        /// <seealso cref="ReReadApprovalCallback"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                _provisionalAlternateEncoding = (value) ? System.Text.Encoding.GetEncoding("UTF-8") : ZipFile.DefaultEncoding;
            }
        }
    ...
    public enum ZipEntrySource
    {
        ...
        /// <summary>
        /// The entry was instantiated via <see cref="Zip.ZipFile.AddEntry(string,string,string)"/> or
        /// <see cref="Zip.ZipFile.AddEntry(string,string,System.IO.Stream)"/> .
        /// </summary>
        Stream,
