...
namespace UpdateBuilder.ZIPLib.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        /// cref="ExtractAll(string,UpdateBuilder.ZIPLib.Zip.ExtractExistingFileAction)" />
        ...
        /// </remarks>
        /// 
        /// <seealso cref="CaseSensitiveRetrieval"/>
        /// <seealso cref="Extract(string,UpdateBuilder.ZIPLib.Zip.ExtractExistingFileAction)"/>
        ///
        /// <param name="entryName">
