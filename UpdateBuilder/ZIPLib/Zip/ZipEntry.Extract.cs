...
namespace UpdateBuilder.ZIPLib.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///         
        /// <seealso cref="ExtractExistingFile"/>
        /// <seealso cref="ExtractWithPassword(UpdateBuilder.ZIPLib.Zip.ExtractExistingFileAction,string)"/>
        ///
        /// <remarks>
        ///
        ...
        /// 
        /// <seealso cref="ExtractExistingFile"/>
        /// <seealso cref="ExtractWithPassword(string,UpdateBuilder.ZIPLib.Zip.ExtractExistingFileAction,string)"/>
        ///
        /// <remarks>
        /// <para> Existing entries in the filesystem will not be overwritten. If you would
        /// like to force the overwrite of existing files, see the <see
        ...
        /// </code>
        /// </example>
        /// <seealso cref="Extract(System.IO.Stream)"/>
